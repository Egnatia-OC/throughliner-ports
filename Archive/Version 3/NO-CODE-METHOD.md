...
- `UX.md` — the user-facing description of the app: every functionality and UI element the user experiences, and why the user needs it.
...
- `BACKLOG.md` — deferred changes not yet built, organised as batches.
...
**Header.** A brief statement of purpose, plus the ordering rule: the top batch is the next build (after any one currently in progress).
