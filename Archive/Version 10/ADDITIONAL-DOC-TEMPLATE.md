...
This doc only describes what has been decided. Open questions live in `BACKLOG.md` as planning batches, not here as placeholders or as sentences that gesture at the doc's own undecidedness. (Same rule as `UX.md`. Full source-of-truth-doc rules: see `NO-CODE-METHOD.md` → *The documents that describe my projects* → *Additional source-of-truth docs*.)

This doc is locked during builds. Flag any change in chat at the end of your response; do not edit mid-build.
