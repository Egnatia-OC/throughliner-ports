...
This doc only describes what has been decided. Open questions live in `BACKLOG.md` as planning batches, not here as placeholders. (Same rule as `UX.md`. Full source-of-truth-doc rules: see `NO-CODE-METHOD.md` → *The documents that describe my projects* → *Additional source-of-truth docs*.)
