...
The structural specification for each doc — required sections, entry shape, rules for additional source-of-truth docs — lives in `DOC-STRUCTURE.md`. Read the relevant section of that file when planning, migrating an existing project's docs onto this method, or writing or editing a doc entry.
