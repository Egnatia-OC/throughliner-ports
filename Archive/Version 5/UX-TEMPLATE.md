...
`UX.md` only describes what has been decided. Open questions and undecided details do NOT live here as placeholders — they live in `BACKLOG.md` as planning batches.

[One paragraph: what this app is, what it does, what makes it different from existing apps in the space. Fill in once the project's basic identity is settled. Delete this instruction line when filled in.]
...
[As above. The "the user needs this because..." line is required for every entry.]
