...
| 0089 | INDEX relocation to proxies | Move BACKLOG INDEX.md and build-log INDEX.md content into `_method/proxies/`. Folders keep only per-entry files. Depends on 0081. |
| 0090 | TEST-LOG folder split + proxy index | Split TEST-LOG.md into test-log/ folder; `_method/proxies/test-log.md` becomes folder index. Supersedes 0076. Depends on 0081, 0089. |
| 0091 | Dev-side terminology and BACKLOG alignment | Rename session→batch, PLAN.md→BACKLOG, merge OPEN-QUESTIONS. Dev-internal only. |
