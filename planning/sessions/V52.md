...
- `plugin/agents/adopt.md` — `/setup` scaffolding gains `build-log/` folder
...
- Smoke-testable via `--plugin-dir`: run a build; verify per-build file created and index updated
