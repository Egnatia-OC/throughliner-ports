...
- Smoke-testable via `--plugin-dir` against a fixture with additional docs declared, Red flags content, and aged fold-in blocks
...
- **Fold-in aging depends on V45.** V45 creates the distributed fold-in sections. By V54, fold-in sections exist in consumer projects. If V45 hasn't shipped, item 3 is a no-op (no fold-in sections to scan).
