...
93 batches (V18–0095 + V60+). 67 shipped, 3 cancelled, 1 superseded, 1 parked, 21 queued/active. 14 open questions.
...
## Open questions (14 entries, L123–L325)

- L129 **Session close as a `/close` skill** — 10-step close is failure-prone from memory; design session needed
