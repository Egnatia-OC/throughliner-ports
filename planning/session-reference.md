...
Method-side = describes how the consumer method works. Dev-internal files (`build-log/`, `test-log/`, `BACKLOG.md`, these session files) don't carry the footer.
...
| `planning/session-protocol.md` | **Living.** Session lifecycle — always read. | Never. |
| `planning/session-reference.md` (this file) | **Living.** Entry shapes, lists, historical — dip on demand. | Never. |
