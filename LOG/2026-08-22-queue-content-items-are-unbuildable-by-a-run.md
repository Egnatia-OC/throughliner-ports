...
Rule gate: run — escalation to a hook; no keep-step clause added.

**Work processed:** kept — [queue-content-items-are-unbuildable-by-a-run], absorbing [audit-cannot-read-queue-prose].
