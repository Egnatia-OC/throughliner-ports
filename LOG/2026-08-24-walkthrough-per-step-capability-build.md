...
Rule gate: run — amendment to next.md's pre-hand-off light capability check, changing its grain from per-item to per-step in place; nothing evicted. Admitted on the recorded instance under the single-instance test.

Files touched: plugin/throughliner/docs/next.md
Routed to Captures: none
Done, confirmed: per-step reads as operative text with the scope-offer clause riding it.
