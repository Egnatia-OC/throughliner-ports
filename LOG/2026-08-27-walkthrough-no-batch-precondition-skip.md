...
**Queue changes:** [walkthrough-no-batch-precondition-skip] filed and cleared; [user-items-batch-skipped-on-precondition-judgment] deleted as merged.
**Work processed:** kept — [walkthrough-no-batch-precondition-skip].
