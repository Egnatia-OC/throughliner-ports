...
Rule gate: run — amendment to the dependency-ownership fate bullet, plus a clause on plan.md's fold conditions; nothing evicted. Admission: no recorded failure yet — admitted on your direction to prepare for a scheduled first use, a known imminent case rather than an imagined one, said plainly rather than dressed as an instance.

Files touched: plugin/throughliner/docs/skill-nonspecific-rules.md; plugin/throughliner/docs/plan.md; plugin/throughliner/templates/faq-template.md, faq-index-template.md; FAQ/faq.md, FAQ/index.md (re-copied)
Routed to Captures: none
Done, confirmed: the clause conditions on more than one person present.
