...
## [HASH] — /next [narration-vocabulary]: plugin-behaviour.md Communication gains a Vocabulary section naming background-only terms with the translate-or-omit narration rule
