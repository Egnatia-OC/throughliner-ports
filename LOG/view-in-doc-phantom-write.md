# c77969c — view-in-doc pointer treatment: added a write-then-verify-then-point ordering rule to plugin-behaviour.md and applied it at the pointer-emit sites in plan.md and next.md
