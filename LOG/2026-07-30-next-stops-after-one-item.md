# 3ca0e2e — Audit: /next terminates the run at the first [user] item by spec (not model misbehaviour); filed 3 findings and corrected the Verso-transcript-as-proof record [next-stops-after-one-item]
