...
- [HASH] — /plan: 6 batches promoted — [fenced-block-content-type-label] and [plan-resolves-by-default] from captures; [plugin-behaviour-walkthrough-1], [plugin-behaviour-walkthrough-2], [next-split-by-type], [done-closeout-extraction] from docs-size concern. Auto-memory staleness researched (resources/research/auto-memory-staleness.md filed); two stale project-state memory files deleted. Docs-grow-but-bugs-don't-fall capture removed after promotion into structural batches.
