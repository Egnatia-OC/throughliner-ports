...
- [HASH] — next.md Step 5: expanded "Abort and requeue" from one phrase to a 3-step procedure — return batch to QUEUE.md per Dependency ownership, captures route as normal, user runs /done with LOG entry describing the attempt
