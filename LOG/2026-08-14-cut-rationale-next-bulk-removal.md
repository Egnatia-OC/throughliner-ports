...
One sentence in the step above was explicitly kept and is not part of this cut: that the pointer-not-copy decision is safe *because* of the copy-per-item ordering, and that a later author changing one must revisit the other. That is operative, not rationale — it tells a future editor what they may not do.

**Files touched:** `plugin/throughliner/docs-b/next.md` (−17 lines).
