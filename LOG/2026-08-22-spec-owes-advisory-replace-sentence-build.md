...
Tick: done, confirmed (entry states both routes; FAQ/ matches the template byte-for-byte).

Rule gate: not needed — consumer-facing description of shipped behaviour; no method rule authored.
FAQ: updated — the "Last session advises…" entry; FAQ/ re-copied.

**Files touched:** plugin/throughliner/templates/faq-template.md, FAQ/faq.md, FAQ/index.md
