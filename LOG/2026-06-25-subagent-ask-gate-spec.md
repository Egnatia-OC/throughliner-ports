# acbbe31 — SPEC.md "How it works" hooks list — extended the pre_tool_use bullet to also name the subagent ask-gate (a cost guard that asks before Claude spawns a subagent, never blocks), alongside scope-lock and git safety.
