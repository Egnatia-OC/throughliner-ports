# 3db6a25 — plugin-behaviour.md Communication — added a "don't assume the user's environment" guard: surface the setup a step needs and let the user judge whether it's theirs
