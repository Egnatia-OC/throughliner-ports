...
The instruction that follows them — do not reintroduce `Blocks:` / `Depends on:` headers, because the one dependency field is `Blocked by:` on the item that is held — is operative and stays. It is a live prohibition on a future author, not an account of a past decision.

**Files touched:** `plugin/throughliner/docs-b/done-plan.md` (−16 lines).
