...
Rule gate: run — amendment to plan.md's merge/supersession block, reworded in place; no new rule is added and nothing is evicted. The operative clarification is admitted on the recorded misapplication, per the reclassify-don't-exempt rule.

Files touched: plugin/throughliner/docs/plan.md
Routed to Captures: none
Done, confirmed: delete-and-read classifies the clause operative.
