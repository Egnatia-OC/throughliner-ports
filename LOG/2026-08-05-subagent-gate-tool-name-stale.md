# [HASH] — pre_tool_use.py subagent ask-gate now matches both tool names "Task" and "Agent" (docstrings updated) — restores the gate under the harness's current Agent tool name
