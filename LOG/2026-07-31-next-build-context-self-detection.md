# [HASH] — next-build.md Context-management section — removed the false "if context is running low" self-detection framing; kept the finish-vs-close-partial advice for when the user reports the squeeze
