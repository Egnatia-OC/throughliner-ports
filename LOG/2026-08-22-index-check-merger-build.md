...
Tick: done, confirmed (no restatement remains; the cite-the-file clause survives).

Rule gate: run — merger under the eviction step; the always-loaded rule is the surviving statement, and plan.md's copy is what came out.
