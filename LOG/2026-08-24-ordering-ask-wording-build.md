...
Files touched: plugin/throughliner/docs/plan.md; plugin/throughliner/docs/feedback-and-inbox.md; plugin/throughliner/templates/faq-template.md; FAQ/faq.md, FAQ/index.md (re-copied)
Routed to Captures: none
Done, confirmed: grep clean; both arms present; FAQ/ byte-match.
