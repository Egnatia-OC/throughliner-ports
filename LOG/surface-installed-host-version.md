# ec7ce6f — session_start.py surfaces the installed host version; deferred-test convention wording corrected to reinstall-sufficiency across plan.md, done.md, and QUEUE.md
