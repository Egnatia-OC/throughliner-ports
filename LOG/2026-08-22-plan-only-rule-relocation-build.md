...
Tick: done, confirmed (grep: "Inside /plan only" gone from docs/; plan.md's section verified present).
...
FAQ: not needed because the offer's behaviour is unchanged — only where the rule lives moved.
