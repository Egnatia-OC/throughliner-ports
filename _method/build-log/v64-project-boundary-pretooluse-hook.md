...
**What shipped.** Scope 0065. New PreToolUse check (g) — blocks Edit/Write/MultiEdit outside project root. Fires before all other writing-tool checks. Mode-aware deny with `[Sovereign Implementer]` prefix. 5 new tests (152 total, zero regressions). INVENTORY, Reference manual, BUILD-METHOD updated. Footer V57→V58; plugin 0.57.0→0.58.0.
