...
**Carried forward.** Smoke test deferred (each deny path × two modes). Plan-mode hook firing unverified. V45 forward dependency: fold-in carve-out needs its own `[Sovereign Implementer]` message.
