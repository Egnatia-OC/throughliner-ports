...
3. **Open the test session** by appending rows to `TEST-LOG.md` — one row per distinct user-observable behaviour your recap will name as needing testing. Each row:
